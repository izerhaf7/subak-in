...
const STRINGS = {
  id: {
    ...
    beranda_sub: "SubakIn adalah decision support system untuk mengatasi kelebihan panen di Jawa Barat.",
    ...
    beranda_stat_rentang_label: "puncak ke dasar",
    beranda_stat_horizon_value: "{n} minggu",
    beranda_stat_horizon_label: "peringatan sebelum harga jatuh",
  ...
  en: {
    ...
    beranda_stat_rentang_label: "peak to trough",
    beranda_stat_horizon_value: "{n} weeks",
    beranda_stat_horizon_label: "warning before the price falls",
    beranda_stat_puncak_value: "W{n}",
