...
const STRINGS = {
  id: {
    ...
    kpi_index: "Indeks {n}",
    kpi_peak_price: "Proyeksi harga saat panen raya",
    ...
    map_hint_sim: "Klik wilayah untuk detail, atau klik sentra (garis tebal saat dipilih) untuk mensimulasikan jadwal tanam",
  ...
  en: {
    ...
    kpi_index: "Index {n}",
    kpi_peak_price: "Projected price at harvest peak",
    ...
    map_hint_sim: "Click a region for details, or click a sentra (bold outline when selected) to simulate its planting schedule",
